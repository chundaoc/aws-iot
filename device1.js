...
device
  .on('connect', function() {
    ...
    device.publish('topic/test', 'connected to topic/test' );
    });
...
// Thing Shadow named 'device1'.
//
    thingShadows.register( 'device1' );
//
// 2 seconds after registering, update the Thing Shadow named 
// 'myest' with the latest device state and save the clientToken
...
//
    setTimeout( function() {
       clientTokenUpdate = thingShadows.update('device1', rgbLedLampState  );
       }, 2000 );
    });
